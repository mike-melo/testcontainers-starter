...
public class RedisBackedCacheTest {
    ...
    @Rule
    public GenericContainer redis = new GenericContainer<>("redis:latest").withExposedPorts(6379);
    private Cache cache;
    ...
    public void setUp() throws Exception {
        ...
        cache = new RedisBackedCache(jedis, "TestContainers_Cache");
    }

    @Test
    public void sanityCheck() {
        assertTrue("Redis server should be spun up", redis.isRunning());
    }
